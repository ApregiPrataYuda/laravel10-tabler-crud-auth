...
<div class="page-body">
    <div class="container-xl">
        <div class="card w-100"> <!-- Card tetap lebar -->
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('Administrator.save.product') }}" class="mx-auto col-md-6">
                    @csrf
                    
    
                    <div class="mb-3">
                        <label class="form-label">Name Product**</label>
                        <input type="text" class="form-control" value="{{ old('name_product') }}" name="name_product">
                        @error('name_product')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_category" name="id_category">
                           ...
                           <option class="text-uppercase" value="{{ $item->id_category }}" 
                               {{ old('id_category') == $item->id_category ? 'selected' : '' }}>
                               {{ $item->name_category }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description_product" rows="8">{{ old('description_product') }}</textarea>
