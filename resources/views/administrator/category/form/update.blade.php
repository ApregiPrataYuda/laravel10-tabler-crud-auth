...
<div class="page-body">
    <div class="container-xl">
        <div class="card w-100"> <!-- Card tetap lebar -->
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('Administrator.update.category', $id) }}" class="mx-auto col-md-6">
                    @csrf
                    @method('PUT')
    
                    <div class="mb-3">
                        <label class="form-label">Name Category**</label>
                        <input type="text" class="form-control" value="{{ $row->name_category }}" name="name_category">
                        @error('name_category')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description_category" rows="8">{{ $row->description_category }}</textarea>
